package it.dping.backend.controllers;
...
import it.dping.backend.repository.TutorialRepository;
...
public class TutorialController {
    ...
    //RETRIEVE OPERATION
    //You use @GetMapping annotation for handling GET HTTP requests, then Repository’s findAll(), findByTitleContaining(title), findByPublished() method to get the result.
    ...
    //CREATE OPERATION
    //use @PostMapping annotation for handling POST HTTP requests.
    ...
    //DELETE OPERATION
    //You use @DeleteMapping for DELETE HTTP requests.
